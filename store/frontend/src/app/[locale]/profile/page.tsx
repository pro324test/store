          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              {isEditing ? (
                ...
                <p className="text-sm p-2 bg-muted rounded-md">{user.fullName}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? (
                ...
                <p className="text-sm p-2 bg-muted rounded-md">{user.email || t('not_provided')}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? (
                ...
                <p className="text-sm p-2 bg-muted rounded-md">{user.phoneNumber}</p>
              )}
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {user.roles.map(r => r.role).join(', ') || t('no_roles')}
                </p>
              </div>
            </div>
            <div>
